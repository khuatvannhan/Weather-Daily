...
import com.nhankv.weather.adapters.PlacesAutoCompleteAdapter;
import com.nhankv.weather.listeners.RecyclerItemClickListener;
import com.nhankv.weather.utility.Constants;
...
public class PlacesAutoCompleteActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutocompleteView = (EditText) mToolbar.findViewById(R.id.autocomplete_places);

        delete = (ImageView) mToolbar.findViewById(R.id.search_video_cancel);
